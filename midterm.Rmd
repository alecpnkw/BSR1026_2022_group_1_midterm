---
title: "An Exploratory Investigation of PCLO and Liver Cancer: Code Supplement"
...
Organized by primary and secondary analyses carried out by each team member. Breakdown of the variable assignments are explained below. 

Primary variables:

- Age: Bryce
- Mutation burden: Rozalyn
- Recurrence: Paul and Alec
- Survival status: Ariana
- Metastasis: Tri

Secondary variables:

- Sex: Tri and Bryce
- Hepatitis history: Alec
- Alcohol history: Ariana
- Liver fibrosis: Rozalyn
- BMI: Paul
...
load("data/LiverFibrosis_Subset_Complete_Dataset_MidtermProject_02_13_22.RData")
